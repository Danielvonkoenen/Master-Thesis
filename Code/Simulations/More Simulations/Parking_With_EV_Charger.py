...
def car(name, env, parking_loot, car_type, p_space, num_tickets, ChargingStation, export_data, export_data1):
...
def car_generator(env, parking_loot, charge_station, export_data, export_data1):
    ...
    for i in itertools.count():
        ...
        env.process(car('Car %d' % i, env, parking_loot, car_type, p_space, num_tickets, charge_station, export_data, export_data1))
